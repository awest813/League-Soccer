...
static const char* kPieceKey[3] = {"setpiece_free_kick", "setpiece_corner",
                                   "setpiece_goal_kick"};
...
SetPieceEditorPage::SetPieceEditorPage(Gui2WindowManager* windowManager,
  ...
  Gui2Caption* title =
      new Gui2Caption(windowManager, "caption_spe_title", 0, 8, 100, 4,
                      Localization::GetInstance().Translate("setpiece_title"));
  ...
  // Header
  grid->AddView(new Gui2Caption(windowManager, "spe_h0", 0, 0, 20, 3,
                                Localization::GetInstance().Translate("setpiece_header")),
                0, 0);
  grid->AddView(new Gui2Caption(windowManager, "spe_h1", 0, 0, 6, 3,
                                Localization::GetInstance().Translate("setpiece_depth") + " -"),
                0, 1);
  grid->AddView(new Gui2Caption(windowManager, "spe_h2", 0, 0, 10, 3,
                                Localization::GetInstance().Translate("setpiece_depth")),
                0, 2);
  grid->AddView(new Gui2Caption(windowManager, "spe_h3", 0, 0, 6, 3,
                                Localization::GetInstance().Translate("setpiece_depth") + " +"),
                0, 3);
  grid->AddView(new Gui2Caption(windowManager, "spe_h4", 0, 0, 6, 3,
                                Localization::GetInstance().Translate("setpiece_width") + " -"),
                0, 4);
  grid->AddView(new Gui2Caption(windowManager, "spe_h5", 0, 0, 10, 3,
                                Localization::GetInstance().Translate("setpiece_width")),
                0, 5);
  grid->AddView(new Gui2Caption(windowManager, "spe_h6", 0, 0, 6, 3,
                                Localization::GetInstance().Translate("setpiece_width") + " +"),
                0, 6);
  ...
  for (int i = 0; i < kNumPieces; i++) {
    ...
    grid->AddView(new Gui2Caption(windowManager, "spe_name_" + sfx, 0, 0, 20, 3,
                                  Localization::GetInstance().Translate(kPieceKey[i])),
                  row, 0);
  ...
  Gui2Button* btnSave = new Gui2Button(
      windowManager, "spe_save", 0, 0, 18, 3, Localization::GetInstance().Translate("action_save"));
